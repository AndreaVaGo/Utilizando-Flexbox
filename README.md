...
│   ├── base.css       → variables, reset y estilos generales
...
- `feature/html-structure` → estructura HTML base
- `feature/flexbox-layout` → estilos CSS con Flexbox y módulos
- `feature/responsive` → media queries para móvil
- `feature/typography` → tipografía y estilos visuales
- `feature/links` → enlaces requeridos por el enunciado
...
- `Add flexbox layout and CSS modules` → CSS modularizado con variables y Flexbox
